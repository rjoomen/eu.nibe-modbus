    ...
    socket.on('connect', () => {
      ...
      this.pollingInterval = setInterval(() => {
        ...
        Promise.all([
            ...
            client.readInputRegisters(9, 1),    // BT6 - Hot water
            ...
            var temperature_hot_water = results[7].response._body._valuesAsBuffer;
            var temperature_calculated_supply = results[8].response._body._valuesAsBuffer;
            var heating_pump = results[9].response._body._valuesAsBuffer;
            var source_pump = results[10].response._body._valuesAsBuffer;
            var priority = results[11].response._body._valuesAsBuffer;
            var rmu_s40_temperature = results[12].response._body._valuesAsBuffer;
            var energy_usage = results[13].response._body._valuesAsBuffer;
            ...
            temperature_hot_water = temperature_hot_water.readInt16BE().toString() / 10;                    // scale factor is 10
            ...
            this.setCapabilityValue('measure_temperature.hot_water', temperature_hot_water);
